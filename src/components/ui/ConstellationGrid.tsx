...
export function ConstellationGrid({ isDarkMode }: { isDarkMode: boolean }) {
    ...
    useEffect(() => {
        ...
        // Use alpha: true to make the canvas background transparent, 
        // allowing the section's background color to show through
        ...
        const render = (now: number) => {
            ...
            // Clear instead of fill to respect the parent background
            ctx.clearRect(0, 0, width, height);

            const nodeColor = isDarkMode ? '255, 255, 255' : '15, 23, 42';
            const accentColor = '255, 107, 53'; // Fixed accent color to match #FF6B35

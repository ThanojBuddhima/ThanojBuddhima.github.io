...
const initialItems: ProjectItem[] = [
  {
    ...
    images: ['/achievements/aichallenge.avif'],
    type: 'achievement',
    teamName: 'Gmora',
  },
  {
    ...
    githubUrl: '',
    images: ['/achievements/innovatex.avif'],
    type: 'achievement',
    teamName: 'Gmora',
  },
  {
    ...
    githubUrl: '',
    images: ['/achievements/octwave.avif'],
    type: 'achievement',
    teamName: 'MetaMind',
  },
  {
    ...
    githubUrl: '',
    images: ['/achievements/bitcode.avif'],
    type: 'achievement',
    teamName: 'Gmora',
  },
  {
    ...
    images: ['/achievements/hackelite.avif'],
    type: 'achievement',
    teamName: 'MetaMind',
  },
  {
    ...
    githubUrl: '',
    images: ['/achievements/algoarena.avif'],
    type: 'achievement',
    teamName: 'Gmora',
  }
];
